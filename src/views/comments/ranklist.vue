<template>
    <!-- 好友列表 -->
    <div class="fixed2 rank" @click.stop="_selfClose()">
        <div class="list-cont rank-cont center" @click.stop>
            <div class="list-title rank-title">好友排行榜</div>
            <div class="list-list rank-wrap">
                <div class="rank-label flex-bt">
                    <p>排名</p>
                    <p>昵称</p>
                    <p>小鸡等级</p>
                </div>
                <div class="rank-list list-scroll" ref="rankScroll">
        ...
        .rank-cont {
            ...
            .rank-list {
                ...
                .rank-item {
                    ...
                    .rn-1 {
                        background: url(http://xjccfile.pceggs.com:8080/xjyx/egg/img/rn1.png) no-repeat center;
                        background-size: .4rem auto;
                    }

                    .rn-2 {
                        background: url(http://xjccfile.pceggs.com:8080/xjyx/egg/img/rn2.png) no-repeat center;
                        background-size: .4rem auto;
                    }

                    .rn-3 {
                        background: url(http://xjccfile.pceggs.com:8080/xjyx/egg/img/rn3.png) no-repeat center;
                        background-size: .4rem auto;
                    }
